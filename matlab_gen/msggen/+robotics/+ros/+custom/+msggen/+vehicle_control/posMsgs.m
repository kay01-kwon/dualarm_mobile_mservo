classdef posMsgs < robotics.ros.Message
    %posMsgs MATLAB implementation of vehicle_control/posMsgs
    ...
    properties (Constant)
        MessageType = 'vehicle_control/posMsgs' % The ROS message type
    end
    ...
    methods
        function obj = posMsgs(msg)
            %posMsgs Construct the message object posMsgs
        ...
        function set.XEst(obj, xest)
            ...
            validateattributes(xest, {'numeric'}, {'nonempty', 'scalar'}, 'posMsgs', 'XEst');
        ...
        function set.YEst(obj, yest)
            ...
            validateattributes(yest, {'numeric'}, {'nonempty', 'scalar'}, 'posMsgs', 'YEst');
        ...
        function set.PhiEst(obj, phiest)
            ...
            validateattributes(phiest, {'numeric'}, {'nonempty', 'scalar'}, 'posMsgs', 'PhiEst');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.vehicle_control.posMsgs.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.vehicle_control.posMsgs;
            obj.reload(strObj);
        end
    end
end
